...
func (Module) Tools() []tool.Tool {
	return readmodule.BuildList(readmodule.Spec{
		ListTool: "list_run_events", Scope: "control_center_ansible_runs_read",
		BasePath: "/api/v1/assistant/machine/control_center/ansible/runs/{run_id}/events",
